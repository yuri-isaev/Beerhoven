...
import static ru.mobile.beerhoven.ui.notifications.notification.NotificationFragmentDirections.*;
import static ru.mobile.beerhoven.ui.notifications.notification.NotificationListAdapter.*;
...
public class NotificationListAdapter extends Adapter<NotificationViewHolder> {
   ...
   public void onBindViewHolder(@NonNull NotificationViewHolder holder, int position) {
      ...
      holder.itemView.setOnClickListener(v -> {
         ...
         ActionNavNotificationsToNavOrder action = actionNavNotificationsToNavOrder().setID(confirmID);
