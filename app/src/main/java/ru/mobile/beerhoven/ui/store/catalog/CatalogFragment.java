...
public class CatalogFragment extends Fragment {
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
      ...
      mCatalogViewModel.getCatalogList().observe(getViewLifecycleOwner(),
          (List<Product> list) -> mCatalogAdapter.notifyDataSetChanged());
   ...
   private void initRecyclerView() {
      ...
      mCatalogAdapter = new CatalogAdapter((List<Product>) mCatalogViewModel.getCatalogList().getValue(),
         ...
         public void onInteractionAdd(Product product) {
            mCatalogViewModel.addProductToCart().observe(getViewLifecycleOwner(),
                s -> Toasty.success(requireActivity(), R.string.product_add_cart, Toast.LENGTH_SHORT, true).show());
         }
   ...
   private void onItemSearch(String searchText) {
      ...
      List<Product> products = requireNonNull(mCatalogViewModel.getCatalogList().getValue());
